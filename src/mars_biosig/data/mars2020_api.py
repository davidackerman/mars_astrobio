...
class Mars2020:
    ...
    def get_data(self, results=100, page=1, cameras=["MCZ_LEFT", "MCZ_RIGHT"], sort="newest"):
        ...
        for image in api_res["images"]:
            ...
            date_taken_utc = datetime.datetime.fromisoformat(image["date_taken_utc"].replace('Z', '+00:00'))
            date_received = datetime.datetime.fromisoformat(image["date_received"].replace('Z', '+00:00'))
            drive = image["drive"]
            sol = image["sol"]
